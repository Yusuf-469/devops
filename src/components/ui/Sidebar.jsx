  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-20 z-30 glass-morphism-dark border-r border-white/5 flex flex-col">
      ...
      <div className="p-4 border-b border-white/5 group relative cursor-pointer" onClick={() => scrollToSection(0)}>
        <div className="w-16 h-16 mx-auto rounded-xl bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center hover:scale-110 transition-transform shadow-lg shadow-teal-500/30 relative overflow-hidden">
          <img src="/logo.png" alt="HEALIX" className="w-14 h-14 object-contain" />
        </div>
        {/* HEALIX Tooltip */}
