      ...
      >
        ...
        <div className="corner-features">
          ...
          >
            ...
            <button className="w-full py-3 bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold rounded-xl hover:from-red-400 hover:to-red-500 transition-all duration-300 flex items-center justify-center gap-2">
